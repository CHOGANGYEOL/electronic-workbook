...
export const UC_2023_03: Question = {
	questionId: 202303,
	title: '2023 상시 3회차',
	contents: [
		{
			contentId: 1,
			question: '다음 중 Windows 10의 바로 가기 키에 대한 설명으로 옳지 않은 것은?',
			answer: [
				'[Alt]+[Esc]는 ‘시작’을 클릭한 것처럼 시작 메뉴를 표시한다.',
				'[Shift]+[F10]은 선택한 항목의 바로 가기 메뉴를 표시한다.',
				'바로 가기 아이콘의 ‘속성’ 창에서 바로 가기 키를 지정할 수 있다.',
		...
		{
			contentId: 3,
			question: '다음 중 Windows 10의 [메모장]에 관한 설명으로 옳지 않은 것은?',
			answer: [
		...
		{
			contentId: 4,
			question: '다음 중 한글 Windows 10에서의 프린터 설치에 관한 설명으로 옳지 않은 것은?',
			answer: [
				...
				'공유된 프린터를 사용하려면 프린터가 연결된 컴퓨터의 전원이 켜져 있어야 한다.',
			],
			correct: 2,
		},
		{
			contentId: 5,
			question: '다음 중 [드라이브 조각 모음 및 최적화]를 수행할 수 있는 대상으로 옳은 것은?',
			answer: [
				'외장 하드디스크 드라이브',
				'네트워크 드라이브',
				'CD-ROM 드라이브',
		...
		{
			contentId: 9,
			question: '다음 중 컴퓨터에서 사용하는 유니코드(Unicode)에 대한 설명으로 옳지 않은 것은?',
			answer: [
				'세계 각국의 언어를 통일된 방법으로 표현할 수 있게 제안된 국제적인 코드 규약의 이름이다.',
				'데이터의 원활한 교환을 위해 1개의 문자를 8비트로 통일하였다.',
		...
		},
		{
			...
			answer: ['PPM(Paper Per Minute)', 'DPI(Dots Per Inch)', 'CPS(Character Per Second)', 'BPS(Bits Per Second)'],
			correct: 2,
		},
		{
			contentId: 12,
			question: '다음 중 CMOS 셋업 프로그램에서 설정할 수 없는 항목은?',
			answer: [
				'시스템 암호 설정',
				'하드디스크의 타입',
		...
		},
		{
			...
			answer: [
				...
				'셰어웨어 : 베타 테스트를 하기 전에 제작 회사 내에서 테스트할 목적으로 제작된 프로그램이다.',
			],
			correct: 2,
		},
		{
			...
			answer: [
				'일괄 처리는 컴퓨터에 입력하는 데이터를 일정량 또는 일정시간 동안 모았다가 한꺼번에 처리하는 방식이다.',
		...
		{
			contentId: 18,
			question: '다음 중 한글 Windows에서 전자우편(E-mail) 사용에 관한 설명으로 옳지 않은 것은?',
			answer: [
		...
		},
		{
			contentId: 20,
			question:
				'정보시스템을 통하여 전자문서를 전송하기 위해서는 정보보호를 위하여 보안 서비스가 필요하다. 다음 중 보안 서비스에 해당하지 않는 것은?',
			answer: ['부인방지', '기밀성', '무결성', '확장성'],
			correct: 4,
		},
		{
			contentId: 21,
		...
		},
		{
			...
			answer: [
				...
				'분수를 입력하려면 01/2와 같이 분수 앞에 0을 입력한 뒤 한 칸 띄고 분수를 입력한다.',
		...
		{
			contentId: 24,
			question: '다음 중 공유된 통합 문서에 대한 설명으로 옳지 않은 것은?',
			answer: [
				'암호로 보호된 공유 통합 문서에서 보호를 해제하여도 통합 문서의 공유 상태는 해제되지 않는다.',
				'공유 통합 문서를 네트워크 위치에 복사해도 다른 통합 문서와의 연결은 그대로 유지된다.',
				'여러 사용자가 동시에 동일한 셀을 변경하려면 충돌이 발생한다.',
				'병합된 셀, 조건부 서식, 데이터 유효성 검사, 차트, 그림과 같은 일부 기능은 공유 통합 문서에서 추가하거나 변경할 수 없다.',
			],
			correct: 1,
		},
		{
			...
			answer: [
				'소수점 오른쪽의 자리표시자 보다 더 긴 숫자가 소수점 이하의 숫자로 셀에 입력될 경우 자리표시자 만큼 소수 자릿수로 내림된다.',
		...
		{
			contentId: 28,
			question: '다음 중 아래 시트에서 각 수식을 실행했을 때의 결과 값으로 옳지 않은 것은?',
			questionBody: <img src={IMAGES.Img_28} />,
			answer: [
				'=EOMONTH(A1, -3) → 2020-12-31',
				'=DAYS(A1, A3) → 36',
				'=NETWORKDAYS(A1, A2) → 11',
				'=WORKDAY(A1, 10) → 2021-03-19',
			],
			correct: 2,
		},
		{
		...
		},
		{
			...
			answer: [
				'엑셀을 사용할 때마다 매크로를 사용할 수 있게 하려면 매크로 저장위치를 ‘개인용 매크로 통합 문서’를 선택한다.',
		...
		},
		{
			...
			answer: [
				'매크로를 한 단계씩 이동하면서 매크로의 흐름과 각 동작에 대한 정보를 확인할 수 있다.',
		...
		{
			contentId: 43,
			question: '다음 중 특정 필드의 입력 마스크를 ‘LA09#’으로 설정하였을 때 입력 가능한 데이터로 옳은 것은?',
			answer: ['12345', 'A상345', 'A123A', 'A1BCD'],
			correct: 2,
		},
		{
			contentId: 44,
			question: '다음 중 E-R 다이어그램 표기법의 기호와 의미가 바르게 연결된 것은?',
			answer: [
				'사각형 - 속성(Attribute) 타입',
		...
		},
		{
			contentId: 45,
			question:
				'다음 중 [학생] 테이블의 ‘S_Number’ 필드를 [데이터시트 보기] 상태에서는 ‘학번’으로 표시하고자 할 때 설정해야 할 항목은?',
			answer: ['형식', '캡션', '스마트태그', '입력마스크'],
			correct: 2,
		},
		{
			contentId: 46,
		...
		},
		{
			...
			answer: [
				...
				'오늘 날짜가 ‘2023-03-06’이면 03/06으로 표시된다.',
			],
			correct: 4,
		},
		{
		...
		{
			contentId: 59,
			question: '다음 중 아래와 같이 표시된 폼의 탐색 단추에 대한 설명으로 옳지 않은 것은?',
			questionBody: <img src={IMAGES.Img_59} />,
			answer: [
				'ᄀ 첫 레코드로 이동한다.',
				'ᄂ 이전 레코드로 이동한다.',
				'ᄃ 마지막 레코드로 이동한다.',
				'ᄅ 이동할 레코드 번호를 입력하여 이동한다.',
			],
			correct: 4,
		},
		{
			contentId: 60,
			question: '액세스에서 다음과 같은 폼을 편집하고자 한다. 다음 중 편집에 대한 설명이 옳지 않은 것은?',
			questionBody: <img src={IMAGES.Img_60} />,
			answer: [
				'(1)번 부분을 더블클릭하면 폼의 속성 창을 열 수 있다.',
				'(2)번의 세로 눈금자를 클릭하면 본문의 모든 컨트롤을 선택할 수 있다.',
				'(3)번 부분을 더블클릭하여 폼 바닥글의 배경색을 변경할 수 있다.',
